...
// import java.util.Locale.Category; // Remove this incorrect import
import com.example.mart.entity.Category; // Add the correct import for your domain model
...
public class MartRepositoryTest {
    ...
    public void testDelete3() {
        // testDelete2는 직접 제거 , 3은 부모쪽에 cascade 써서 제거
    ...
    public void testOrderInsert2() {
        ...
        // orderItemRepository.save(orderItem);
        // 부모쪽에 cascadeType.PERSIST 를 써서 가능
    ...
    public void joinTest() {
        ...
        for (Object[] objects : list) {
            ...
            OrderItem orderItem = (OrderItem) objects[2]; // OrderItem
            System.out.println(order);
            System.out.println(member);
