...
public class BoardService {
        ...
        public void delete(Long bno) {
                // 연관관계에 있는 데이터를 정리해야함 => 댓글
                // 1.SQL : 댓글 선 삭제 후 게시글 삭제 or 댓글 부모를 null로 변경 후 삭제
        ...
        public BoardDTO getRow(Long bno) {
                ...
                // [Board(bno=40, title=title40, content=content40),
                // Member(email=user8@gmail.com, password=1111, name=USER8), 9]
