...
public class MovieRepositoryTest {
    ...
    public void reviewInsertTest() {
        // 리뷰 200개 , 영화 100개 무작위로 추출 , 멤버 무작위
        IntStream.rangeClosed(1, 200).forEach(i -> {

            // int movie = (int) (Math.random() * 100) + 1;
            Long mno = (long) (Math.random() * 100) + 1;

            // int member = (int) (Math.random() * 20) + 1;
    ...
    public void getMovieTest() {
        ...
        // Movie(mno=2, title=Movie2), MovieImage(inum=7,
        // uuid=069e7ac6-6692-4399-ac42-b1153fcf12f9, imgName=movie2.jpg, path=null,
        // ord=4), 2, 2.0]
