...
public class SecurityTest {
    ...
    public void testEncoder() {
        ...
        // passwordEncoder.encoder(원비밀번호) : 암호화
        String encoderPassword = passwordEncoder.encode(password);
        // password1111,encoderPasseord :
        // {bcrypt}$2a$10$eSLTIIcROx58tfiJTW9Jeu3CmL5WMKE3VJkLHlS01ncwROGLzLTOq <=
        // 암호화되었음
        System.out.println("password " + password + "," + "encoderPasseord : " + encoderPassword);
